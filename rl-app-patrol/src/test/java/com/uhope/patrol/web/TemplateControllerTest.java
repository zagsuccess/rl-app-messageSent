...
/**
 * {@link com.uhope.patrol.web.TemplateController} Tester.
 *
 * @author xiepuyao
 * @version 1.0
...
public class TemplateControllerTest {
    ...
    public void testList() throws Exception {
        ...
        String pageSize = "5";
        String result =
                mockMvc.perform(MockMvcRequestBuilders.get("/v1/patrol/list")
