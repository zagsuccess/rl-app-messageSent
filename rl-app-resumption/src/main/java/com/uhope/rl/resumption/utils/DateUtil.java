...
public class DateUtil {
    ...
    public static int getIntervalMonths(String date, String otherDate) {
        return getIntervalMonths(StringToDate(date), StringToDate(otherDate));
    }
    ...
    @Test
    public void test(){
        System.out.println(Math.abs(DateUtil.getMonth("2017-05-06")-DateUtil.getMonth("2017-08-06")));
    }
}