package com.uhope.rl.resumption.utils;
...
public class TimeUtil {
    ...
    public static Date getStartTime(int type){
        if(type == 1)return getNowYearStart();
        else if(type == 2)return getNearMonth(0);
        else if(type == 3)return getNearMonth(-1);
        else if(type == 4)return getThisWeekDay(0,2);
        else if(type == 5)return getThisWeekDay(-1,2);
        else if(type == 6)return getNearDay(0,0,0,0,0);
        else if(type == 7)return getNearDay(-1,0,0,0,0);
