...
public class WaterqualityRealTime implements Serializable {
    @Id
    private String id;
    private String code;
    ...
    public WaterqualityRealTime() {
    }

    public WaterqualityRealTime(String id, String code, String sectionname, String riverName, Date statisticaltime, Double wt, Double totalphosphorus, Double ammonium, Double permanganate, Double dissolvedoxygen) {
        this.id = id;
        this.code = code;
